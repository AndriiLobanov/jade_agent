package nure2.search.csp.solver;

import java.util.List;
import java.util.Optional;
import java.util.stream.Collectors;

import nure2.search.csp.Assignment;
import nure2.search.csp.CSP;
import nure2.search.csp.Variable;
import nure2.search.csp.solver.inference.AC3Strategy;
import nure2.search.csp.solver.inference.InferenceLog;
import nure2.search.csp.solver.inference.InferenceStrategy;
