package nure2.agent.impl.aprog;

import java.util.Optional;
import java.util.Set;

import nure2.agent.AgentProgram;
import nure2.agent.impl.DynamicState;
import nure2.agent.impl.ObjectWithDynamicAttributes;
import nure2.agent.impl.aprog.simplerule.Rule;
